...
\newcommand{\ppod}{\textbf{Pensando O Direito}}
...
\newglossaryentry{widget}{
	name=\textit{widget},
	description={componente de uma interface gráfica do usuário (GUI), o que inclui janelas, botões, menus, ícones, barras de rolagem, etc.}
}
\newglossaryentry{sidebar}{
	name=\textit{sidebar},
	description={uma espécie de menu lateral que normalmente oferece uma navegação auxiliar ao conteúdo principal que está sendo apresentado.}
}
...
%\newdualentry{cms}{CMS}{\textit{Content Management System}}{Sistema de Gestão de Conteúdos}

%\newdualentry{ui}{UI}{\textit{User Interface}}{Interface de Usuário}

\newdualentry{cpt}{CPT}{\textit{Custom Post Type}}{Tipo de conteúdo personalizado do Wordpress com características próprias definidas pelo desenvolvedor. Mais informações em: \url{https://codex.wordpress.org/Post\_Types\#Custom\_Post\_Types}}
