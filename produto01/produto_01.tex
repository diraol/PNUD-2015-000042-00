...
\include{auxiliares/pacotes-configuracoes}
\include{auxiliares/comandos-extras}
\include{auxiliares/configuracoes-gerais}
\include{textos/siglas}
% ---
% compila o indice
\makeindex
...
\include{textos/ficha-catalografica}
...
\input{textos/desenvolvimento-dadospessoais}
\input{textos/desenvolvimento-marcocivil}
\input{textos/desenvolvimento-metodoagil}
...
% ----------------------------------------------------------
\bibliography{../produtos}


% ---
% inserindo listas (tabelas, ilustrações, etc.)
\include{textos/listas}
